...
class Caisse(models.Model):
    heure_ouv = models.DateTimeField(blank=True, default=datetime.datetime.now)
    heure_close = models.DateTimeField(blank=True, default=datetime.datetime.now)
...
class Vente(models.Model):
    ...
    timev = models.DateTimeField(blank=True, default=datetime.datetime.now)
